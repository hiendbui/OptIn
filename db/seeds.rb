...
User.create([{email: 'chefcurry@gmail.com', password: 'stephcurry09'}])
Profile.create([{user_id: User.last.id, full_name: 'Steph Curry', location: 'San Francisco Bay Area', headline: 'NBA Athlete, Entrepreneur, Investor, Producer', description: 'Believer. Husband to Ayesha, father to Riley, Ryan and Canon, son, brother. Golden State Warriors guard. Davidson Wildcat. Executive Producer. Investor. Entrepreneur. Philippians 4:13.'}])
